...
void base_cache::initialize(){
    ...
    cout<<"cache size of node "<<getParentModule()->getIndex()<<" is" << cache_size<<endl;
    ...
    else if (decision_policy.compare("custo_cache")==0 )
       {
           decisor = new Custo_cache();
       }
