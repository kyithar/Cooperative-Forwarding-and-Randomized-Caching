...
class ccn_interest_Base : public ::cPacket
{
  ...
  public:
    ...
    virtual bool getAggregate() const;
    virtual void setAggregate(bool aggregate);
    virtual int getI_type() const;
    virtual void setI_type(int i_type);
    virtual int getCusto() const;
    virtual void setCusto(int custo);
    virtual int getCount() const;
    virtual void setCount(int count);
    virtual int getClid() const;
    virtual void setClid(int clid);
};
