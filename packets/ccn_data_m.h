...
class ccn_data_Base : public ::cPacket
{
  ...
  public:
    ...
    virtual int getC_decision() const;
    virtual void setC_decision(int c_decision);
    virtual double getCur_req() const;
    virtual void setCur_req(double cur_req);
    virtual int getOne_hop_found() const;
    virtual void setOne_hop_found(int one_hop_found);
};
